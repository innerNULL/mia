...
#
# Usage:
# python ./bin/benchmarks/medqa/run.py bin/benchmarks/medqa/run.ollama.json
...
def main() -> None:
    ...
    for sample in tqdm(samples):
        ...
        cnt += 1
        print("Vars: option_out={}, option_correct={}".format(option_out, option_correct))
        print("Accuracy: {}".format(succ_cnt / cnt))
